(function($) {
    ...
    -------------------------------------------*/
    if ($("#clock").length) {
        $('#clock').countdown('2021/04/22', function(event) {
    ...
    $(window).on("click", function(e) {
        //to toogle dropdown music-box
        if (e.target.class != "music-box-toggle-btn" && e.target.class != "fa-music" &&
    ...
    function activeMenuItem($links) {
        ...
        sections.each(function() {
            ...
            if (cur_pos >= top && cur_pos <= bottom) {
                ...
                nav.find('a[data-nav-section="'+$(this).attr('id')+'"]').parent().addClass("current-menu-item");
            } else if (cur_pos === 2) {
                nav.find("> ul > li > a").parent().removeClass("current-menu-item");
            }
